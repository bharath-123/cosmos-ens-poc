...
import (
	...
	"cns/docs"
	registrymodule "cns/x/registry"
	registrymodulekeeper "cns/x/registry/keeper"
	registrymoduletypes "cns/x/registry/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport
)

const (
	AccountAddressPrefix = "stader"
	Name                 = "cns"
)
...
type App struct {
	*baseapp.BaseApp
	...
	ScopedRegistryKeeper capabilitykeeper.ScopedKeeper
...
func New(
	...
	scopedRegistryKeeper := app.CapabilityKeeper.ScopeToModule(registrymoduletypes.ModuleName)
	app.ScopedRegistryKeeper = scopedRegistryKeeper
	...
	ibcRouter.AddRoute(registrymoduletypes.ModuleName, registryModule)
