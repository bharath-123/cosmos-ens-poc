...
func (am AppModule) OnRecvPacket(
	...
	var modulePacketData types.RegistryPacketData
	...
	case *types.RegistryPacketData_RecordBroadcastPacket:
		packetAck, err := am.keeper.OnRecvRecordBroadcastPacket(ctx, modulePacket, *packet.RecordBroadcastPacket)
		if err != nil {
		...
		ctx.EventManager().EmitEvent(
			sdk.NewEvent(
				types.EventTypeRecordBroadcastPacket,
...
func (am AppModule) OnAcknowledgementPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.RegistryPacketData_RecordBroadcastPacket:
		err := am.keeper.OnAcknowledgementRecordBroadcastPacket(ctx, modulePacket, *packet.RecordBroadcastPacket, ack)
		if err != nil {
			return err
		}
		eventType = types.EventTypeRecordBroadcastPacket
...
func (am AppModule) OnTimeoutPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.RegistryPacketData_RecordBroadcastPacket:
		err := am.keeper.OnTimeoutRecordBroadcastPacket(ctx, modulePacket, *packet.RecordBroadcastPacket)
		if err != nil {
			return err
		}
